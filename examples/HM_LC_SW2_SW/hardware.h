...
//	#define EXT_BATTERY_MEASUREMENT												// comment out to use internal battery measurement
	...
	#define DEBOUNCE                   5
		...
		#define BATT_ENABLE_DDR        DDRC										// define battery measurement enable pin, has to be low to start measuring
		#define BATT_ENABLE_PORT       PORTC
		#define BATT_ENABLE_PIN        PORTC0
